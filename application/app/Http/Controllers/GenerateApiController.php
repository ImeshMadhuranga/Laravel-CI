...
class GenerateApiController extends Controller
{
    ...
    public function createKey(Request $request)
    {
        ...
        if(strstr($domain,'localhost') || strstr( $domain, '192.168.' ) || strstr($domain,'.test') || strstr($domain,'learnkad.com') || strstr($domain,'mediacity.co.in') || strstr($domain,'castleindia.in')){
             $put = 1;
