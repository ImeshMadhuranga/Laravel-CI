                ...
                <div class="card-header">
                    ...
                    <div>
                        ...
                        <button type="button" class="float-right btn btn-danger-rgba mr-2" data-toggle="modal" data-target="#bulk_delete" title="{{ __('Delete Selected') }}"><i
                                  ...
                                  @endcan
                                  @can('pages.create')
                        <a href="{{url('page/create')}}" class="float-right btn btn-primary-rgba mr-2" title="{{ __('Add Page') }}"><i class="feather icon-plus mr-2"></i>{{ __('Add Page') }}</a>
                        @endcan
                        </div>
                      </div>
                </div> 
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                            @can('pages.edit')
                                            <a class="dropdown-item" href="{{url('page/'.$p->id.'/edit')}}" title="{{ __('Edit') }}"><i class="feather icon-edit mr-2"></i>{{ __('Edit') }}</a>
                                            @endcan
                                            @can('pages.delete')
