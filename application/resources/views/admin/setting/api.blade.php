...
@section('maincontent')
<?php
$data['heading'] = 'Payment Gateways Setting';
$data['title'] = 'Payment Gateways Setting';
?>
                        ...
                        <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                            <div class="row">
                                <div class="col-md-12 form-group">
                                    <label class="text-dark" for="s_enable">{{ __('STRIPE Payment Gateway Settings') }}</label><br>
                                </div>
